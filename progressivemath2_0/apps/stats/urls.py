...
urlpatterns = [
    ...
    path('work/get-all/theme-sorted', views.get_works_sorted_by_theme, name='get all works which sorted by theme'),
    ...
    path('work/grade/update', views.update_work_grades, name='update work grades'),
